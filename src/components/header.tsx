...
export default function Header() {
  return (
    <header className="z-9999 w-full min-h-12 flex items-center justify-around gap-3 py-1 bg-white fixed border-b-2 border-r-4 border-l-4 border-red text-red rounded-b-2xl">
